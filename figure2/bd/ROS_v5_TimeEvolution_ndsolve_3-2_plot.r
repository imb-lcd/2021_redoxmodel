...
#### read data
sol <- read.table("ROS_v5_TimeEvolution_ndsolve_3-2_out.txt", header = TRUE, sep = "\t") 
...
ap1b
ggsave2("ROS_v5_TimeEvolution_ndsolve_3-2_plot_1.pdf", width = 5, height = 2.4, units = "in", dpi = 600)

ap1c <- plot_grid(p2e, p3e, p5e, p6e, nrow = 2, align = "hv", axis = "tblr")
ap1d <- plot_grid(ap1c, leg, rel_widths = c(8, 2))
ap1d
ggsave2("ROS_v5_TimeEvolution_ndsolve_3-2_plot_2.pdf", width = 5, height = 2.4, units = "in", dpi = 600)

ap1e <- plot_grid(p7e, p8e, p9e, p10e, ncol = 1)
ap1f <- plot_grid(ap1e, leg2, ncol = 2, rel_widths = c(2, 1))
ggsave2("ROS_v5_TimeEvolution_ndsolve_3-2_plot_3.pdf", width = 3, height = 4.8, units = "in", dpi = 600)
