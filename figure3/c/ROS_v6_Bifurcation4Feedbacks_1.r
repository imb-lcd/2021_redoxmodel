...
#### read data
sol1 <- read.table("ROS_v6_BifurcationCaRosFeedback_solve_1_out.txt", header = TRUE, sep = "\t") 
sol2 <- read.table("ROS_v6_BifurcationCys2NadphFeedback_solve_1_out.txt", header = TRUE, sep = "\t") 
sol3 <- read.table("ROS_v6_BifurcationGshRosFeedback_solve_1_out.txt", header = TRUE, sep = "\t") 
sol4 <- read.table("ROS_v6_BifurcationTkRosFeedback_solve_1_out.txt", header = TRUE, sep = "\t") 
