...
#### read data
sol <- read.table("ROS_v6_BifurcationTkRosFeedback_solve_1_out.txt", header = TRUE, sep = "\t") 
...
ggsave2("ROS_v6_BifurcationTkRosFeedback_solve_1.pdf", width = 5.4, height = 3.6, units = "in")
