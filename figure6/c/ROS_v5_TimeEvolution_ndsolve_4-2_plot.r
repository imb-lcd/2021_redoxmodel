...
#### read data
sol <- read.table("ROS_v5_TimeEvolution_ndsolve_4-2_out.txt", header = TRUE, sep = "\t") 
...
ap1e
ggsave2("ROS_v5_TimeEvolution_ndsolve_4-2_plot_3.pdf", width = 2, height = 4.8, units = "in", dpi = 600)
