...
#### read data
sol <- read.table("ROS_v5_TimeEvolution_ndsolve_4-3_out.txt", header = TRUE, sep = "\t") 
...
ap1b
ggsave2("ROS_v5_TimeEvolution_ndsolve_4-3_plot_1.pdf", width = 5, height = 2.4, units = "in", dpi = 600)

ap1c <- plot_grid(p2e, p3e, p5e, p6e, nrow = 2, align = "hv", axis = "tblr")
ap1d <- plot_grid(ap1c, leg, rel_widths = c(8, 2))
ap1d
ggsave2("ROS_v5_TimeEvolution_ndsolve_4-3_plot_2.pdf", width = 5, height = 2.4, units = "in", dpi = 600)
...
ap1e
ggsave2("ROS_v5_TimeEvolution_ndsolve_4-3_plot_3.pdf", width = 2, height = 4.8, units = "in", dpi = 600)
